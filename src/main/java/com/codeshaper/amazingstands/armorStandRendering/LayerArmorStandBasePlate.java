...
public class LayerArmorStandBasePlate implements LayerRenderer<EntityArmorStand> {
	...
	@Override
	public void doRenderLayer(EntityArmorStand armorStand, float p_177162_2_, float p_177162_3_, float p_177162_4_,
			float p_177162_5_, float p_177162_6_, float p_177162_7_, float p_177162_8_) {
		...
		if (stack != null && !armorStand.hasNoBasePlate()) {
			...
			// XXX This sort of removes the vanilla feature of the stand never rotating by
			// 45*, but I kind of like it moving.
			...
			blockrendererdispatcher.renderBlockBrightness(
					Block.getBlockFromItem(stack.getItem()).getStateFromMeta(stack.getMetadata()), 1.0F);
