...
@Mod(modid = AmazingStands.MOD_ID, version = AmazingStands.VERSION, updateJSON = "https://github.com/RangerPJ/AmazingStands/blob/master/src/main/resources/assets/amazingstands/updates.json", name = "Amazing Stands")
